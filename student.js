...
let phone = document.getElementById("inp_phone");
...
submit.onclick = function () {
    ...
    if (flag == 0)
        ...
        info.innerHTML = "<p>Name : " + name.value + "</p><p>Email : " + email.value + "</p><p>Phone no. : " + phone.value + "</p><p>Gender : " + selected + "</p><p>Skills : " + skillbox + "</p>";
